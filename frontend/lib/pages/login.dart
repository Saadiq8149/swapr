...
Future<void> login(
  ...
  final userDetails = {'password': password, 'username': username};
  try {
    final response = await http.post(url, body: userDetails);
    final responseBody = jsonDecode(response.body);
    if (response.statusCode == 200) {
      final token = responseBody['access_token'];
      await FlutterSessionJwt.saveToken(token);
      // showErrorAlert("Login Successful", context, color: Colors.green);
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Image(
                            image: AssetImage('assets/icons/google_white.png'),
                            width: 20,
                          ),
                          Padding(
